...
module.exports.run = async (client, message, args) => {
  //if(!message.guild) return message.author.send(new discord.MessageEmbed().setColor(client.config.red).setTitle("This command can't b
...
module.exports.help = {
  name: "addcuss",
  aliases: [],
  description: "Add cuss words to your server that members can't say",
  usage: "<word>",
  category: "Configs"
}