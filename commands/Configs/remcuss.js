...
if(prefix === null) prefix = client.config.prefix
  ...
  let cmdname = args[0]
    ...
    if(database) {
      ...
      return message.channel.send(new discord.MessageEmbed().setColor(client.config.red).setTitle("There was an error deleting the blacklisted word, if this keeps on occuring please contact the developer"))
  }
}
...
module.exports.help = {
  name: "remcuss",
  aliases: [],
  description: "Remove a cuss word from your server",
  usage: "<word>",
  category: "configs"
}